...
//    un = un->prev;
//    uk = uk->prev;
//    un->obj.setWidth(uk->obj.getWidth());
//    un->obj.setHeight(uk->obj.getHeight());
//    un->obj.setThickness(uk->obj.getThickness());
//    un->obj.setCoordinateX(uk->obj.getCoordinateX());
//    un->obj.setCoordinateY(uk->obj.getCoordinateY());
//}
//un->prev = nullptr;
...
//    std::cout << (xc - firstX) << ' ' << firstW << ' '  << (yc - firstY) << ' ' << firstH;
